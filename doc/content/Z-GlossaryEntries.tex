...
\newglossaryentry{glos:thinClientLabel}{
  name=Thin Client,
  plural={Thin Clients},
  description={Ein Thin Client ist ein günstiger, rechen-schwacher Computer. Er wird dazu verwendet, um arbeiten zu erledigen die auf einem rechen-starken Server statt findet. Ein Thin Client übernimmt hauptsächlich die Bereitstellung von \Glspl{glos:ioDeviceLabel}.}
}
\newglossaryentry{glos:homeOfficeLabel}{
  name=Home Office,
  description={Mit Home Office wird das Arbeiten von Zuhause genannt. Dabei wird oft eine sichere Verbindung von Zuhause auf die Infrastruktur der Firma erzeugt.}
}
