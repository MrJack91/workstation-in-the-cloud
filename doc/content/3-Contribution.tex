...
% Seite 9: RSA Secure ID für Login. Benötigt Security Username, Passwort & Token für login. Two two-factor authentication.
% Seite 10: HTTPS Zugang möglich zwischen Terminal und VDM Connection Server
% Seite 10: Server können in einer DMZ gestartet werden. Verbindung über Internet möglich. Einige Server laufen in der Sicheren Zone, andere in der DMZ.
% Seite 10/11: High-availability mit load balancing
% Seite 10/11: VDM Security Servers müssen nicht teil vom LDAP/Active Diretory sein.
% Seite 24: LDAP anbindung möglich

% Eigene Sicherheit
% Korrekt implementierte Firewall auf Clients & Servers
% HTTP Access verbieten
...
Korrekt Umgesetzt kann damit eine sichere Infrastruktur aufgebaut werden, welche sicher gegenüber Ausfällen und Häckerattacken ist. Ein zusätzlicher Vorteil ist, dass die Daten in der Firma gehosted sind und die Sicherheitszone niemals verlassen.
