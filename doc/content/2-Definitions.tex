...
\section{Infastructure-as-a-Service (IaaS): Workstation}
...
Bei vielen Anwendungen gibt es tägliche, Sesonale, Jährliche, oder andere Belastungsspitzen, zu welcher mehr Leistung benötigt wird. 
...
Mit IaaS kann dynamisch zu Lastzeiten mehr Leistung zugemietet werden.

\subsubsection{Ausfallsicherheit}
Um eine annähernde Ausfallsicherheit von 100\% zu erreichen braucht es redundante Hardware, wodurch die Kosten für die Anschafung und den Betrieb rasch steigen.
Für eine Firma kann dies rasch sehr kostspielig werden.

\subsubsection{Skallierbarkeit}
...
Die kosten können für das Business kalkuliert werden, da diese vorausschaubar sind.
Es müssen keine Wartungen, Ersatzteile oder ähnliches in das Budget miteingerechnet werden.
